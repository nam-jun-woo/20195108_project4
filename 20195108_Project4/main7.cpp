...
int main() {
	vector<Sprite*>list;
	int width, height;
	cout << "보드 크기를 입력하시오[최대 10X10]" << endl;
	cout << "가로 : ";
	cin >> width;
	...
	drawLine('*');
	cout << "이게임의 목적은 함정(T)이나 적(E)를 만나지 않고 보물에 도달하는것이다";
	cout << "주인공은 a,s,w,d 키를 이용하여 움직일수 있다" << endl;
	drawLine('*');
	cout << endl;
